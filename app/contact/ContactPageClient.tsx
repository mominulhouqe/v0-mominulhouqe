    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
          Have a question, feedback, or just want to say hello? We'd love to hear from you. Fill out the form below or
          ...
          <div className="lg:col-span-1">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Reach out to us using any of these methods</CardDescription>
              </CardHeader>
